...
public class EnrollCtrlTest {
	...
	public void cannotTakeWithoutPrePassed() throws EnrollmentRulesViolationException {
		bebe.addStudyRecordItem(phys1, new Term("t1"), 18);
		bebe.addStudyRecordItem(prog, new Term("t1"), 12);
		bebe.addStudyRecordItem(math1, new Term("t1"), 8.4);
	...
	public void canTakeWithPreFinallyPassed() throws EnrollmentRulesViolationException {
		...
		bebe.addStudyRecordItem(phys2, new Term("t2"), 10);
		bebe.addStudyRecordItem(ap, new Term("t2"), 16);
		bebe.addStudyRecordItem(math1, new Term("t2"), 10.5);
	...
	public void canTake14WithGPA11() throws EnrollmentRulesViolationException {
		bebe.addStudyRecordItem(phys1, new Term("t1"), 13);
		bebe.addStudyRecordItem(prog, new Term("t1"), 11);
		bebe.addStudyRecordItem(math1, new Term("t1"), 9);
	...
	public void canTake15WithGPA12() throws EnrollmentRulesViolationException {
		bebe.addStudyRecordItem(phys1, new Term("t1"), 15);
		bebe.addStudyRecordItem(prog, new Term("t1"), 12);
		bebe.addStudyRecordItem(math1, new Term("t1"), 9);
	...
	public void canTake15WithGPA15() throws EnrollmentRulesViolationException {
		bebe.addStudyRecordItem(phys1, new Term("t1"), 15);
		bebe.addStudyRecordItem(prog, new Term("t1"), 15);
		bebe.addStudyRecordItem(math1, new Term("t1"), 15);
	...
	public void canTake20WithGPA16() throws EnrollmentRulesViolationException {
		bebe.addStudyRecordItem(phys1, new Term("t1"), 16);
		bebe.addStudyRecordItem(prog, new Term("t1"), 16);
		bebe.addStudyRecordItem(math1, new Term("t1"), 16);
